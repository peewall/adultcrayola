...
<div class="flex flex-col min-w-screen min-h-[80vh] items-center justify-center container min-w-full">
    <div class="grow flex flex-col items-center justify-center">
        ...
        <div class="mt-8 flex flex-col gap-8 px-12 py-6 border-black border-4 rounded-md hover:rounded-[50%] ease-in-out transition-all bg-[url('bk-mta.jpg')] bg-cover bg-rose-500 bg-blend-screen bg-opacity-75">
            <a href='/projects' class="bg-indigo-500 rounded-sm px-2 py-1">
                <p class="font-main text-2xl text-center uppercase tracking-wide text-amber-50 font-bold">projects</p>
            </a>
            <a href='/posts' class="bg-rose-500 rounded-sm px-2 py-1">
                <p class="font-main text-2xl  text-center uppercase tracking-wide text-amber-50 font-bold">writing</p>
            </a>
        </div>  
    </div>
